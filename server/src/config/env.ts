...
function finiteNumber(parsed: number, fallback: number): number {
...
export const env = {
  ...
  JWT_REFRESH_EXPIRES_DAYS: finiteNumber(parseInt(process.env.JWT_REFRESH_EXPIRES_DAYS ?? "30", 10), 30),
